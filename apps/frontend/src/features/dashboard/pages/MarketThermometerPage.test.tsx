...
describe("MarketThermometerPage", () => {
  ...
  it("renders only spot items with numeric last_price", () => {
    ...
    expect(
      screen.getByTestId("market-thermometer-weighted-strength-value"),
    ).toHaveTextContent("71.3%");
    expect(
      screen.getByTestId("market-thermometer-financial-strength-value"),
    ).toHaveTextContent("44.5%");
    expect(
      screen.getByTestId("market-thermometer-tech-strength-value"),
    ).toHaveTextContent("88.8%");
    expect(
      screen.getByTestId("market-thermometer-strength-score"),
    ).toHaveTextContent("+25.00%");
    expect(
      screen.getByTestId("market-thermometer-strength-count"),
    ).toHaveTextContent("2 symbols");
  });
