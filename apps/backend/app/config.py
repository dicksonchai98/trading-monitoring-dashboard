...
SERVING_ENV = os.getenv("SERVING_ENV", AGGREGATOR_ENV)
SERVING_DEFAULT_CODE = os.getenv("SERVING_DEFAULT_CODE", "")
SERVING_POLL_INTERVAL_MS = _env_int("SERVING_POLL_INTERVAL_MS", 500)
...
SERVING_BEARER_TOKEN = os.getenv("SERVING_BEARER_TOKEN", "dev-serving-token")
...
SERVING_CORS_ALLOW_ORIGINS = _env_list("SERVING_CORS_ALLOW_ORIGINS", ["http://localhost:3000"])
