...
def test_mvp_parser_normalizer_validator_supports_chinese_headers() -> None:
    csv_text = (
        ...
        "\u591a\u65b9\u4ea4\u6613\u5951\u7d04\u91d1\u984d(\u5343\u5143),\u7a7a\u65b9\u4ea4\u6613\u5951\u7d04\u91d1\u984d(\u5343\u5143),"
        "\u591a\u7a7a\u4ea4\u6613\u5951\u7d04\u91d1\u984d\u6de8\u984d(\u5343\u5143),"
        "\u591a\u65b9\u672a\u5e73\u5009\u53e3\u6578,\u7a7a\u65b9\u672a\u5e73\u5009\u53e3\u6578,\u591a\u7a7a\u672a\u5e73\u5009\u53e3\u6578\u6de8\u984d,"
        "\u591a\u65b9\u672a\u5e73\u5009\u5951\u7d04\u91d1\u984d(\u5343\u5143),\u7a7a\u65b9\u672a\u5e73\u5009\u5951\u7d04\u91d1\u984d(\u5343\u5143),"
        "\u591a\u7a7a\u672a\u5e73\u5009\u5951\u7d04\u91d1\u984d\u6de8\u984d(\u5343\u5143)\n"
...
def test_mvp_parser_normalizer_validator_supports_live_taifex_spacing_variant() -> None:
    csv_text = (
        "\u65e5\u671f,\u5546\u54c1\u540d\u7a31,\u8eab\u4efd\u5225,"
        "\u591a\u65b9\u4ea4\u6613\u53e3\u6578,\u591a\u65b9\u4ea4\u6613\u5951\u7d04\u91d1\u984d(\u5343\u5143),"
        "\u7a7a\u65b9\u4ea4\u6613\u53e3\u6578,\u7a7a\u65b9\u4ea4\u6613\u5951\u7d04\u91d1\u984d(\u5343\u5143),"
        ...
        "\u591a\u7a7a\u672a\u5e73\u5009\u53e3\u6578\u6de8\u984d,"
        "\u591a\u7a7a\u672a\u5e73\u5009\u5951\u7d04\u91d1\u984d\u6de8\u984d( \u5343\u5143)\n"
        "2026-03-09,TX,\u5916\u8cc7,100,10,50,5,50,5,120,12,60,6,60,6\n"
    )
    parser = TaifexCsvParser()
    normalizer = TaifexInstitutionOpenInterestNormalizer()
    validator = TaifexInstitutionOpenInterestValidator()
