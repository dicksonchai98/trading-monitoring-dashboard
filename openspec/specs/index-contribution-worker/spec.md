# Index Contribution Worker

## Purpose

This spec defines the real-time attribution behavior and minute snapshot persistence requirements for the dedicated `index_contribution_worker` serving `TSE001`.
